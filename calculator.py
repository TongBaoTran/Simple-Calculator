...
root.iconbitmap('C:/Users/baotr/Desktop/Learning Py/image.ico')
...
#myButton = Button(root, text="Enter Your Name", command=myClick, fg="black", bg="green")



root.mainloop()   # Loop for moving mouse
